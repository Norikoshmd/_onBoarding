        ...
        <div class="modal-content border-danger">
            <div class="modal-header border-danger">
                <h3 class="h5 modal-title text-danger">
                    <i class="fa-solid fa-circle-exclamation"></i> Delete Registered Employee
                </h3>
            </div>
            <div class="modal-body">
                <p>Are you sure you want to delete registered employee '<span class="fw-bold"> {{  $employee->name }}</span>' ?</p>
                <div class="mt-3">
            ...
            <div class="modal-footer border-0">
                <form action="{{ route('recruiter.destroy', $employee->id) }}" method="post">
                    @csrf
                    @method('DELETE')
