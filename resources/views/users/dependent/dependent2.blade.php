...
@section('title','Your Dependents - My Number Card ("Individual Number Card")')

@section('content')

<div class="container bg-white opacity-90 rounded p-3 shadow-lg">
    <div class="h1 h4 mt-2 fw-bold">
        <i class="fa-solid fa-pen-to-square fa-lg"></i> &nbsp;&nbsp;Your Dependent's - My Number Card ("Individual Number Card")
    </div>
    <hr>
    ...
    <h1 class="h6 ms-3"> Please submit all of your dependents(including spouse) My number card(s). </h1>
    <br>
    <h1 class="h6 ms-3"> As it is highly confidential, we request you to either</h1>
    <h1 class="h6 ms-5 fw-bold"> 1. Post(mail out) photocopies(back and front of the card) to our office </h1>
